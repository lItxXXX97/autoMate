...
export function Setting(){
  ...
  const onModelChange = (value: string) => {
    switch (value) {
      ...
      case 'qwen':
        form.resetFields(['llm'])
        form.setFieldsValue({"llm": {model: 'openai/qwen-turbo',api_base: "https://dashscope.aliyuncs.com/compatible-mode/v1" }});
        break;
      default:
    }
  };
  ...
  return (
    ...
    >   
       ...
       <Button
        ...
        <Form.Item name="format" label="模型厂商选择" rules={[{ required: true }]}>
        <Select
